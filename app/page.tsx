...
function ImpactCard ({title, value, icon: Icon}: {title: string, value: string | number, icon: React.ElementType}) {
  return(
    <div className="p-6 rounded-xl bg-gray-50 border border-gray-100 transition-all duration-300 ease-in-out hover:shadow-md">
      ...
      <p className="text-3xl font-base mb-2 text-gray-800">{value}</p>
  ...
  return(
    <div className="container mx-auto px-4 py-16">
      <section className="text-center mb-20">
        <AnimatedGlobe/>
        <h1 className="text-6xl font-bold mb-6 mt-6 text-gray-800 tracking-tight">
        ...
        <Button className="bg-green-600 hover:bg-green-700 text-white py-6 text-lg px-10 rounded-full">Report Waste</Button>
      </section>
      ...
      <section className="grid md:grid-cols-3 gap-10 mb-20">
        ...
        icon={Leaf}
        title="Eco-Friendly"
        description="We are comitted to reducing waste and promoting sustainability"
        />
        <FeatureCard
        icon={Coins}
        title="Earn Rewards"
        ...
        description="Be a part of a growing community committed to sustainable practices "
        />
      </section>
